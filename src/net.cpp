...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("wildwestcoin-ext-ip");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("wildwestcoin-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "wildwestcoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"seed.wildwestcoin.com", "seed.wildwestcoin.com"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("wildwestcoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("wildwestcoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("wildwestcoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("wildwestcoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. wildwestcoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("wildwestcoin-start");
